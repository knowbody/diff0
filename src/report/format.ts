 ...
 * Some tiny positive costs round *up* to "$0.0001" at four decimals rather
 * than down to zero, so any finite value strictly between 0 and $0.0001
 * renders as the literal "<$0.0001" instead of a misleading "$0.0000" that
 * reads as free.
 */
