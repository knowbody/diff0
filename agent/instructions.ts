...
Use build mode only when the requested outcome includes a repository change. Run \`classifier\`, then \`analyst\`, then \`implementer\`, then \`reviewer\`, in that order. Build-mode rules:
