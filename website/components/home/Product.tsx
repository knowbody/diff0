      ...
      <div className="mt-16 grid overflow-hidden rounded-2xl border border-line bg-line shadow-[0_24px_80px_rgba(0,0,0,0.06)] lg:grid-cols-3 lg:gap-px">
        <article className="bg-card p-7 sm:p-9">
          ...
          <div className="mt-8 rounded-xl border border-line bg-codebg p-4 font-mono text-[11px] leading-6">
            ...
            <p className="mt-2 -mx-1 rounded bg-red-500/10 px-1 text-red-500">
              − Delegate summary to reporter
            </p>
            <p className="-mx-1 rounded bg-green-500/10 px-1 text-green-600">
          ...
          <div className="mt-8 rounded-xl border border-line bg-codebg p-4 font-mono text-[11px] leading-6">
            {showcase.evals.map((evaluation) => (
              <p key={evaluation.name} className="flex items-center justify-between gap-3">
                ...
                <span
                  className={evaluation.result === "✅ pass" ? "text-green-600" : "text-accent"}
                >
